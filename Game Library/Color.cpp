...
Color::Color(const std::string& str)
{
    ...
    if (length == 3) {
        int red = strtol(str.substr(0, 1).c_str(), NULL, 16);
        int green = strtol(str.substr(1, 1).c_str(), NULL, 16);
        int blue = strtol(str.substr(2, 1).c_str(), NULL, 16);
        r = red / 15.0f;
        g = green / 15.0f;
        b = blue / 15.0f;
    } else if (length == 6) {
        int red = strtol(str.substr(0, 2).c_str(), NULL, 16);
        int green = strtol(str.substr(2, 2).c_str(), NULL, 16);
        int blue = strtol(str.substr(4, 2).c_str(), NULL, 16);
        r = red / 255.0f;
        g = green / 255.0f;
        b = blue / 255.0f;
    } else {
